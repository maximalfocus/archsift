...
**Record Content Identity**
    ...
    sha256:803ff66c1a6ac4b15a6693f1fe46b4843fb88a70b2d2c24e1dc3595f0ec164d8
...
**Outstanding Gap Rule Ids**

**Outstanding Gap Rule Ids item 1**

    agency-necessity-missing

**Outstanding Gap Rule Ids item 2**

    autonomy-permission-missing

**Outstanding Gap Rule Ids item 3**

    candidate-comparison-missing

**Outstanding Gap Rule Ids item 4**

    problem-value-missing

**Outstanding Gap Rule Ids item 5**

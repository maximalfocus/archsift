...
CORPUS_BASE_SNAPSHOT_RESOURCE = "knowledge/architecture-v1.json"
CORPUS_SNAPSHOT_RESOURCE = "knowledge/architecture-v2.json"
CORPUS_PROPOSAL_RESOURCE = "knowledge/architecture-v2.change.json"

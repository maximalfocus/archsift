...
CORPUS_BASE_SNAPSHOT_RESOURCE = "knowledge/architecture-v4.json"
CORPUS_SNAPSHOT_RESOURCE = "knowledge/architecture-v5.json"
CORPUS_PROPOSAL_RESOURCE = "knowledge/architecture-v5.change.json"

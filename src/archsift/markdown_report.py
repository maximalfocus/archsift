...
_EXPECTED_FIELDS: Final[dict[type[object], tuple[str, ...]]] = {
    ...
    v.HardVeto: ("id", "status", "condition", "consequence", "action_ids", "evidence_ids"),

# ArchSift method specification 1.1.0
...
### `method-v1.1.0#separate-decisions`
...
### `method-v1.1.0#credible-evidence`
...
### `method-v1.1.0#candidate-comparison`
...
### `method-v1.1.0#agency-necessity`
...
### `method-v1.1.0#autonomy-boundaries`
...
### `method-v1.1.0#ordered-elimination`
...
### `method-v1.1.0#verdict-resolution`
...
This table is normative for ruleset `1.7.0`. It is sorted by immutable rule ID.

| Rule ID | Rationale ID | Public source IDs |
|---|---|---|
| `active-veto-applicability-missing` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `active-veto-blocks-candidate` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `agency-answer-unknown` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agency-necessity-missing` | `method-v1.1.0#separate-decisions` | `nist-ai-rmf-1.0`, `oecd-ai-principles-2024` |
| `agentic-agency-answer-unknown` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-agency-fact-non-decisive` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-agency-necessity-missing` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-credible-agency-evidence-missing` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-credible-residual-evidence-missing` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-dynamic-execution-supports-agency` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-feedback-supports-agency` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-feedback-unavailable-blocks-candidate` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-fixed-workflow-insufficiency-supports-agency` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-fixed-workflow-sufficient-blocks-candidate` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-residual-case-missing` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-residual-case-supports-agency` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-runtime-adaptation-missing` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `agentic-runtime-adaptation-supports-agency` | `method-v1.1.0#agency-necessity` | `nist-ai-600-1`, `nist-ai-rmf-1.0` |
| `automation-authority-missing` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `autonomy-answer-unknown` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `autonomy-boundary-non-decisive` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `autonomy-permission-missing` | `method-v1.1.0#separate-decisions` | `nist-ai-rmf-1.0`, `oecd-ai-principles-2024` |
| `baseline-reference-unresolved` | `method-v1.1.0#problem-value` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `binding-constraint-failed` | `method-v1.1.0#ordered-elimination` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `binding-constraint-met` | `method-v1.1.0#ordered-elimination` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `binding-outcome-failed` | `method-v1.1.0#ordered-elimination` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `binding-outcome-met` | `method-v1.1.0#ordered-elimination` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `binding-outcome-missing` | `method-v1.1.0#problem-value` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `candidate-comparison-missing` | `method-v1.1.0#separate-decisions` | `nist-ai-rmf-1.0`, `oecd-ai-principles-2024` |
| `candidate-constraint-test-missing` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `candidate-outcome-test-missing` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `candidate-problem-value-missing` | `method-v1.1.0#separate-decisions` | `nist-ai-rmf-1.0`, `oecd-ai-principles-2024` |
| `candidate-role-incompatible` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `candidate-test-result-unknown` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `comparison-result-unknown` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `credible-agency-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-authority-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-autonomy-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-baseline-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-candidate-test-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-comparison-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-hard-veto-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-human-control-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-residual-case-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `credible-strongest-simpler-evidence-missing` | `method-v1.1.0#credible-evidence` | `nist-ai-rmf-1.0`, `w3c-prov-o-2013` |
| `hard-veto-status-unknown` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `mandatory-human-control-omitted` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `mandatory-human-control-retained` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `overlapping-veto-status-unknown` | `method-v1.1.0#autonomy-boundaries` | `nist-ai-rmf-1.0`, `nist-sp-800-53r5`, `oecd-ai-principles-2024` |
| `problem-value-missing` | `method-v1.1.0#problem-value` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `required-candidate-role-missing` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `required-comparison-missing` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `strongest-simpler-boundary-coverage-missing` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `strongest-simpler-boundary-incompatible` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `strongest-simpler-boundary-missing` | `method-v1.1.0#candidate-comparison` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `task-boundary-missing` | `method-v1.1.0#bounded-task` | `nist-ai-rmf-1.0` |
| `verdict-conditional` | `method-v1.1.0#verdict-resolution` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `verdict-insufficient-evidence` | `method-v1.1.0#verdict-resolution` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `verdict-no-permissible-candidate` | `method-v1.1.0#verdict-resolution` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `verdict-no-technology-change` | `method-v1.1.0#verdict-resolution` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |
| `verdict-supported` | `method-v1.1.0#verdict-resolution` | `nist-ai-rmf-1.0`, `nist-sp-800-30r1` |

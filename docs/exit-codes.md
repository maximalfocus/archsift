...
| `12` | `VALIDATION_FAILED` | A workspace, dossier, declared case language, usability cohort, or method-review result violates its supported contract or success criterion. |
